            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <span id="card_title">
                            <a href="{{ route('categorias.create') }}" class="btn btn-primary btn-md float-right"
                                data-placement="left">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return '<a class="btn btn-info btn-sm" href="/categorias/' +
                                row.id + '/edit"><i class="fas fa-pencil-alt"></i></a>' +
                                '<a class="btn btn-danger btn-sm" onclick="deleteCategory(' +
