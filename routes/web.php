...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/listarFamilias', [DatatableController::class, 'families'])->name('families.list');
    Route::get('/listarFabricantes', [DatatableController::class, 'manufacturers'])->name('manufacturers.list');
    Route::get('/listarLineas', [DatatableController::class, 'lineas'])->name('lineas.list');
