...
class ProductoController extends Controller
{
    ...
    public function create()
    {
        ...
        $fabricantes = Fabricante::pluck('nombre', 'id');
        $lineas = Linea::pluck('nombre', 'id');
        return view('producto.create', compact('producto', 'categorias', 'familias', 'fabricantes', 'lineas'));
    }
    ...
    public function edit($id)
    {
        ...
        $fabricantes = Fabricante::pluck('nombre', 'id');
        $lineas = Linea::pluck('nombre', 'id');
        return view('producto.edit', compact('producto', 'categorias', 'familias', 'fabricantes', 'lineas'));
    }
